...
<form action="#" method="post">
	<fieldset>
		...
		dd
		<select name="dd">
			<option value="01" required>01</option>
			<option value="02" required>02</option>
			<option value="03" required>03</option>
			<option value="04" required>04</option>
		</select>
		mm
		<select name="mm">
			<option value="01" required>01</option>
		...
		<select name="yy">
			...
			<option value="2001" required>2001</option>
			<option value="2002" required>2002</option>
			<option value="2003" required>2003</option>
		</select>
		<br/>
